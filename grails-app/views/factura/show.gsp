...
<html>
    ...
    <body>
        ...
        <div id="show-factura" class="content scaffold-show" role="main">
            ...
            <f:display bean="factura" />
            <g:form resource="${this.factura}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.factura}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
